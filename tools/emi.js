...
<div class="card">  
<div class="title">EMI Calculator</div>  <div class="segmented" id="emi_mode">    
  ...
  </div>      <div class="form-row" id="tenure_wrap">    
    <label>Loan Tenure (Years)</label>    
    <input id="emi_tenure" type="number" value="${tool.prefill?.tenure || 5}">    
  </div>      <div class="form-row" id="emi_wrap" style="display:none">    
    <label>Monthly EMI (₹)</label>    
    <input id="emi_amount" type="number" value="${tool.prefill?.emi || 20000}">    
  </div>    <button id="emi_calc" class="btn-primary">Calculate</button>
...
<div class="value" id="primary_value">--</div>  <div class="row"><span>Principal</span><span id="out_principal">--</span></div>    
...
</p>    <h3>Why Use an EMI Calculator?</h3>    
<p>    
...
</p>    <h3>How Loan Tenure Affects EMI</h3>    
<p>    
  ...
  to smart borrowing.    
</p>    <h3>Benefits of Proper EMI Planning</h3>    
<ul>    
